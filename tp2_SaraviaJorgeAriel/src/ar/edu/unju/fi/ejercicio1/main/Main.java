...
public class Main {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 3:
				...
				break;
			case 4:
				System.out.println("Eligio la Opcion 4, saliendo del programa...");
				break;
			default:
	...
	private static void precargarProductos() {
        productos.add(new Producto("001", "Teléfono móvil", 299.99, Producto.OrigenFabricacion.CHINA, Producto.Categoria.TELEFONIA));
        productos.add(new Producto("002", "Portátil", 899.99, Producto.OrigenFabricacion.ARGENTINA, Producto.Categoria.INFORMATICA));
        productos.add(new Producto("003", "Lavadora", 499.99, Producto.OrigenFabricacion.BRASIL, Producto.Categoria.ELECTROHOGAR));
        productos.add(new Producto("004", "Taladro", 59.99, Producto.OrigenFabricacion.URUGUAY, Producto.Categoria.HERRAMIENTAS));
    }
}
